//--------------------------------------------------------------------
//
//  Laboratory 4                                   TestListArray.java
//
...
class TestListArray
{
	...
	{
		ListArray testList = new ListArray(8);  // Test list
		char testElement = 'c';					// List element
		int n = 0;                              // Position within list
		...
		System.out.println("  M n : Move element marked by cursor to pos. n "
						   + " (Inactive : In-lab Ex. 2)");
		System.out.println("  ?x  : Search rest of list for x               "
						   + " (Inactive : In-lab Ex. 3)");
